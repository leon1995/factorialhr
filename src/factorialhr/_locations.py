...
class LocationsEndpoint(Endpoint):
    ...
    async def all(self, **kwargs) -> ListApiResponse[Location]:
        ...
        Official documentation: `locations/locations <https://apidoc.factorialhr.com/reference/get_api-2026-04-01-resources-locations-locations>`_
    ...
    async def get_by_id(self, location_id: int | str, **kwargs) -> Location:
        ...
        Official documentation: `locations/locations <https://apidoc.factorialhr.com/reference/get_api-2026-04-01-resources-locations-locations-id>`_
    ...
    async def create(self, data: Mapping[str, typing.Any], **kwargs) -> Location:
        ...
        Official documentation: `locations/locations <https://apidoc.factorialhr.com/reference/post_api-2026-04-01-resources-locations-locations>`_
    ...
    async def update(self, location_id: int | str, data: Mapping[str, typing.Any], **kwargs) -> Location:
        ...
        Official documentation: `locations/locations <https://apidoc.factorialhr.com/reference/put_api-2026-04-01-resources-locations-locations-id>`_
    ...
    async def delete(self, location_id: int | str, **kwargs) -> Location:
        ...
        Official documentation: `locations/locations <https://apidoc.factorialhr.com/reference/delete_api-2026-04-01-resources-locations-locations-id>`_
...
class WorkAreasEndpoint(Endpoint):
    ...
    async def all(self, **kwargs) -> ListApiResponse[WorkArea]:
        ...
        Official documentation: `locations/work_areas <https://apidoc.factorialhr.com/reference/get_api-2026-04-01-resources-locations-work-areas>`_
    ...
    async def get_by_id(self, work_area_id: int | str, **kwargs) -> WorkArea:
        ...
        Official documentation: `locations/work_areas <https://apidoc.factorialhr.com/reference/get_api-2026-04-01-resources-locations-work-areas-id>`_
    ...
    async def create(self, data: Mapping[str, typing.Any], **kwargs) -> WorkArea:
        ...
        Official documentation: `locations/work_areas <https://apidoc.factorialhr.com/reference/post_api-2026-04-01-resources-locations-work-areas>`_
    ...
    async def update(self, work_area_id: int | str, data: Mapping[str, typing.Any], **kwargs) -> WorkArea:
        ...
        Official documentation: `locations/work_areas <https://apidoc.factorialhr.com/reference/put_api-2026-04-01-resources-locations-work-areas-id>`_
    ...
    async def archive(self, data: Mapping[str, typing.Any], **kwargs) -> WorkArea:
        ...
        Official documentation: `locations/work_areas <https://apidoc.factorialhr.com/reference/post_api-2026-04-01-resources-locations-work-areas-archive>`_
    ...
    async def unarchive(self, data: Mapping[str, typing.Any], **kwargs) -> WorkArea:
        ...
        Official documentation: `locations/work_areas <https://apidoc.factorialhr.com/reference/post_api-2026-04-01-resources-locations-work-areas-unarchive>`_
