...
class MembershipsEndpoint(Endpoint):
    ...
    async def all(self, **kwargs) -> ListApiResponse[Membership]:
        ...
        Official documentation: `teams/memberships <https://apidoc.factorialhr.com/reference/get_api-2026-04-01-resources-teams-memberships>`_
    ...
    async def get_by_id(self, membership_id: int | str, **kwargs) -> Membership:
        ...
        Official documentation: `teams/memberships <https://apidoc.factorialhr.com/reference/get_api-2026-04-01-resources-teams-memberships-id>`_
    ...
    async def create(self, data: Mapping[str, typing.Any], **kwargs) -> Membership:
        ...
        Official documentation: `teams/memberships <https://apidoc.factorialhr.com/reference/post_api-2026-04-01-resources-teams-memberships>`_
    ...
    async def update(self, membership_id: int | str, data: Mapping[str, typing.Any], **kwargs) -> Membership:
        ...
        Official documentation: `teams/memberships <https://apidoc.factorialhr.com/reference/put_api-2026-04-01-resources-teams-memberships-id>`_
    ...
    async def delete(self, membership_id: int | str, **kwargs) -> Membership:
        ...
        Official documentation: `teams/memberships <https://apidoc.factorialhr.com/reference/delete_api-2026-04-01-resources-teams-memberships-id>`_
...
class TeamsEndpoint(Endpoint):
    ...
    async def all(self, **kwargs) -> ListApiResponse[Team]:
        ...
        Official documentation: `teams/teams <https://apidoc.factorialhr.com/reference/delete_api-2026-04-01-resources-teams-teams-id>`_
    ...
    async def get(self, **kwargs) -> MetaApiResponse[Team]:
        ...
        Official documentation: `teams/teams <https://apidoc.factorialhr.com/reference/get_api-2026-04-01-resources-teams-teams>`_
    ...
    async def get_by_id(self, team_id: int | str, **kwargs) -> Team:
        ...
        Official documentation: `teams/teams <https://apidoc.factorialhr.com/reference/get_api-2026-04-01-resources-teams-teams-id>`_
    ...
    async def create(self, data: Mapping[str, typing.Any], **kwargs) -> Team:
        ...
        Official documentation: `teams/teams <https://apidoc.factorialhr.com/reference/post_api-2026-04-01-resources-teams-teams>`_
    ...
    async def update(self, team_id: int | str, data: Mapping[str, typing.Any], **kwargs) -> Team:
        ...
        Official documentation: `teams/teams <https://apidoc.factorialhr.com/reference/put_api-2026-04-01-resources-teams-teams-id>`_
