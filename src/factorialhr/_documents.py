...
class DocumentsEndpoint(Endpoint):
    ...
    async def all(self, **kwargs) -> ListApiResponse[Document]:
        ...
        Official documentation: `documents/documents <https://apidoc.factorialhr.com/reference/get_api-2026-04-01-resources-documents-documents>`_
    ...
    async def get_by_id(self, document_id: int | str, **kwargs) -> Document:
        ...
        Official documentation: `documents/documents <https://apidoc.factorialhr.com/reference/get_api-2026-04-01-resources-documents-documents-id>`_
    ...
    async def create(self, data: Mapping[str, typing.Any], **kwargs) -> Document:
        ...
        Official documentation: `documents/documents <https://apidoc.factorialhr.com/reference/post_api-2026-04-01-resources-documents-documents>`_
    ...
    async def update(self, document_id: int | str, data: Mapping[str, typing.Any], **kwargs) -> Document:
        ...
        Official documentation: `documents/documents <https://apidoc.factorialhr.com/reference/put_api-2026-04-01-resources-documents-documents-id>`_
    ...
    async def delete(self, document_id: int | str, **kwargs) -> Document:
        ...
        Official documentation: `documents/documents <https://apidoc.factorialhr.com/reference/delete_api-2026-04-01-resources-documents-documents-id>`_
    ...
    async def move_to_trash_bin(self, document_ids: Sequence[int], **kwargs) -> Sequence[Document]:
        ...
        Official documentation: `documents/documents <https://apidoc.factorialhr.com/reference/post_api-2026-04-01-resources-documents-documents-move-to-trash-bin>`_
    ...
    async def restore_from_trash_bin(self, document_ids: Sequence[int], **kwargs) -> Sequence[Document]:
        ...
        Official documentation: `documents/documents <https://apidoc.factorialhr.com/reference/post_api-2026-04-01-resources-documents-documents-restore-from-trash-bin>`_
...
class DownloadUrlsEndpoint(Endpoint):
    ...
    async def bulk_create(self, document_ids: Sequence[int], **kwargs) -> Sequence[DownloadUrl]:
        ...
        Official documentation: `documents/download_urls <https://apidoc.factorialhr.com/reference/post_api-2026-04-01-resources-documents-download-urls-bulk-create>`_
...
class FoldersEndpoint(Endpoint):
    ...
    async def all(self, **kwargs) -> ListApiResponse[Folder]:
        ...
        Official documentation: `documents/folders <https://apidoc.factorialhr.com/reference/post_api-2026-04-01-resources-documents-folders-bulk-create>`_
    ...
    async def get(self, **kwargs) -> MetaApiResponse[Folder]:
        ...
        Official documentation: `documents/folders <https://apidoc.factorialhr.com/reference/get_api-2026-04-01-resources-documents-folders>`_
    ...
    async def get_by_id(self, folder_id: int | str, **kwargs) -> Folder:
        ...
        Official documentation: `documents/folders <https://apidoc.factorialhr.com/reference/get_api-2026-04-01-resources-documents-folders-id>`_
    ...
    async def create(self, data: Mapping[str, typing.Any], **kwargs) -> Folder:
        ...
        Official documentation: `documents/folders <https://apidoc.factorialhr.com/reference/post_api-2026-04-01-resources-documents-folders>`_
    ...
    async def update(self, folder_id: int | str, data: Mapping[str, typing.Any], **kwargs) -> Folder:
        ...
        Official documentation: `documents/folders <https://apidoc.factorialhr.com/reference/put_api-2026-04-01-resources-documents-folders-id>`_
