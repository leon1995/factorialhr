...
class IdentifiersEndpoint(Endpoint):
    ...
    async def all(self, **kwargs) -> ListApiResponse[Payrollemployeesidentifier]:
        ...
        Official documentation: `payroll_employees/identifiers <https://apidoc.factorialhr.com/reference/get_api-2026-04-01-resources-payroll-employees-identifiers>`_
    ...
    async def get_by_id(self, identifier_id: int | str, **kwargs) -> Payrollemployeesidentifier:
        ...
        Official documentation: `payroll_employees/identifiers <https://apidoc.factorialhr.com/reference/get_api-2026-04-01-resources-payroll-employees-identifiers-id>`_
    ...
    async def create(self, data: Mapping[str, typing.Any], **kwargs) -> Payrollemployeesidentifier:
        ...
        Official documentation: `payroll_employees/identifiers <https://apidoc.factorialhr.com/reference/post_api-2026-04-01-resources-payroll-employees-identifiers>`_
    ...
    async def update(
        ...
        **kwargs,
        ...
        Official documentation: `payroll_employees/identifiers <https://apidoc.factorialhr.com/reference/put_api-2026-04-01-resources-payroll-employees-identifiers-id>`_
    ...
    async def delete(self, identifier_id: int | str, **kwargs) -> Payrollemployeesidentifier:
        ...
        Official documentation: `payroll_employees/identifiers <https://apidoc.factorialhr.com/reference/delete_api-2026-04-01-resources-payroll-employees-identifiers-id>`_
