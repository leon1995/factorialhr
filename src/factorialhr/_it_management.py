...
class ItAssetsEndpoint(Endpoint):
    ...
    async def all(self, **kwargs) -> ListApiResponse[ItAsset]:
        ...
        Official documentation: `it_management/it_assets <https://apidoc.factorialhr.com/reference/get_api-2026-04-01-resources-it-management-it-assets>`_
    ...
    async def get_by_id(self, asset_id: int | str, **kwargs) -> ItAsset:
        ...
        Official documentation: `it_management/it_assets <https://apidoc.factorialhr.com/reference/get_api-2026-04-01-resources-it-management-it-assets-id>`_
    ...
    async def create(self, data: Mapping[str, typing.Any], **kwargs) -> ItAsset:
        ...
        Official documentation: `it_management/it_assets <https://apidoc.factorialhr.com/reference/post_api-2026-04-01-resources-it-management-it-assets>`_
    ...
    async def update(self, asset_id: int | str, data: Mapping[str, typing.Any], **kwargs) -> ItAsset:
        ...
        Official documentation: `it_management/it_assets <https://apidoc.factorialhr.com/reference/put_api-2026-04-01-resources-it-management-it-assets-id>`_
    ...
    async def delete(self, asset_id: int | str, **kwargs) -> ItAsset:
        ...
        Official documentation: `it_management/it_assets <https://apidoc.factorialhr.com/reference/delete_api-2026-04-01-resources-it-management-it-assets-id>`_
...
class ItAssetModelsEndpoint(Endpoint):
    ...
    async def all(self, **kwargs) -> ListApiResponse[ItAssetModel]:
        ...
        Official documentation: `it_management/it_asset_models <https://apidoc.factorialhr.com/reference/get_api-2026-04-01-resources-it-management-it-asset-models>`_
    ...
    async def get_by_id(self, model_id: int | str, **kwargs) -> ItAssetModel:
        ...
        Official documentation: `it_management/it_asset_models <https://apidoc.factorialhr.com/reference/get_api-2026-04-01-resources-it-management-it-asset-models-id>`_
    ...
    async def create(self, data: Mapping[str, typing.Any], **kwargs) -> ItAssetModel:
        ...
        Official documentation: `it_management/it_asset_models <https://apidoc.factorialhr.com/reference/post_api-2026-04-01-resources-it-management-it-asset-models>`_
    ...
    async def update(self, model_id: int | str, data: Mapping[str, typing.Any], **kwargs) -> ItAssetModel:
        ...
        Official documentation: `it_management/it_asset_models <https://apidoc.factorialhr.com/reference/put_api-2026-04-01-resources-it-management-it-asset-models-id>`_
