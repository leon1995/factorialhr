...
class DayConfigurationEndpoint(Endpoint):
    ...
    async def all(self, **kwargs) -> ListApiResponse[WorkScheduleDayConfiguration]:
        ...
        Official documentation: `work_schedule/day_configurations <https://apidoc.factorialhr.com/reference/get_api-2026-04-01-resources-work-schedule-day-configurations>`_
    ...
    async def get_by_id(self, day_config_id: int | str, **kwargs) -> WorkScheduleDayConfiguration:
        ...
        Official documentation: `work_schedule/day_configurations <https://apidoc.factorialhr.com/reference/get_api-2026-04-01-resources-work-schedule-day-configurations-id>`_
    ...
    async def bulk_cud(self, data: Mapping[str, typing.Any], **kwargs) -> WorkScheduleDayConfiguration:
        ...
        Official documentation: `work_schedule/day_configurations <https://apidoc.factorialhr.com/reference/post_api-2026-04-01-resources-work-schedule-day-configurations-bulk-cud>`_
...
class OverlapPeriodEndpoint(Endpoint):
    ...
    async def all(self, **kwargs) -> ListApiResponse[WorkScheduleOverlapPeriod]:
        ...
        Official documentation: `work_schedule/overlap_periods <https://apidoc.factorialhr.com/reference/get_api-2026-04-01-resources-work-schedule-overlap-periods>`_
    ...
    async def get_by_id(self, overlap_period_id: int | str, **kwargs) -> WorkScheduleOverlapPeriod:
        ...
        Official documentation: `work_schedule/overlap_periods <https://apidoc.factorialhr.com/reference/get_api-2026-04-01-resources-work-schedule-overlap-periods-id>`_
    ...
    async def create(self, data: Mapping[str, typing.Any], **kwargs) -> WorkScheduleOverlapPeriod:
        ...
        Official documentation: `work_schedule/overlap_periods <https://apidoc.factorialhr.com/reference/post_api-2026-04-01-resources-work-schedule-overlap-periods>`_
    ...
    async def update(
        ...
        **kwargs,
        ...
        Official documentation: `work_schedule/overlap_periods <https://apidoc.factorialhr.com/reference/put_api-2026-04-01-resources-work-schedule-overlap-periods-id>`_
    ...
    async def delete(self, overlap_period_id: int | str, **kwargs) -> WorkScheduleOverlapPeriod:
        ...
        Official documentation: `work_schedule/overlap_periods <https://apidoc.factorialhr.com/reference/delete_api-2026-04-01-resources-work-schedule-overlap-periods-id>`_
...
class ScheduleEndpoint(Endpoint):
    ...
    async def all(self, **kwargs) -> ListApiResponse[WorkScheduleSchedule]:
        ...
        Official documentation: `work_schedule/schedules <https://apidoc.factorialhr.com/reference/get_api-2026-04-01-resources-work-schedule-schedules>`_
    ...
    async def get_by_id(self, schedule_id: int | str, **kwargs) -> WorkScheduleSchedule:
        ...
        Official documentation: `work_schedule/schedules <https://apidoc.factorialhr.com/reference/get_api-2026-04-01-resources-work-schedule-schedules-id>`_
    ...
    async def create(self, data: Mapping[str, typing.Any], **kwargs) -> WorkScheduleSchedule:
        ...
        Official documentation: `work_schedule/schedules <https://apidoc.factorialhr.com/reference/post_api-2026-04-01-resources-work-schedule-schedules>`_
    ...
    async def update(
        ...
        **kwargs,
        ...
        Official documentation: `work_schedule/schedules <https://apidoc.factorialhr.com/reference/put_api-2026-04-01-resources-work-schedule-schedules-id>`_
    ...
    async def toggle_archive(self, data: Mapping[str, typing.Any], **kwargs) -> WorkScheduleSchedule:
        ...
        Official documentation: `work_schedule/schedules <https://apidoc.factorialhr.com/reference/post_api-2026-04-01-resources-work-schedule-schedules-toggle-archive>`_
