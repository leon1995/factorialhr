...
class TasksEndpoint(Endpoint):
    ...
    async def all(self, **kwargs) -> ListApiResponse[Task]:
        ...
        Official documentation: `tasks/tasks <https://apidoc.factorialhr.com/reference/get_api-2026-04-01-resources-tasks-tasks>`_
    ...
    async def get_by_id(self, task_id: int | str, **kwargs) -> Task:
        ...
        Official documentation: `tasks/tasks <https://apidoc.factorialhr.com/reference/get_api-2026-04-01-resources-tasks-tasks-id>`_
    ...
    async def create(self, data: Mapping[str, typing.Any], **kwargs) -> Task:
        ...
        Official documentation: `tasks/tasks <https://apidoc.factorialhr.com/reference/post_api-2026-04-01-resources-tasks-tasks>`_
    ...
    async def update(self, task_id: int | str, data: Mapping[str, typing.Any], **kwargs) -> Task:
        ...
        Official documentation: `tasks/tasks <https://apidoc.factorialhr.com/reference/put_api-2026-04-01-resources-tasks-tasks-id>`_
    ...
    async def delete(self, task_id: int | str, **kwargs) -> Task:
        ...
        Official documentation: `tasks/tasks <https://apidoc.factorialhr.com/reference/delete_api-2026-04-01-resources-tasks-tasks-id>`_
    ...
    async def bulk_create(self, data: Mapping[str, typing.Any], **kwargs) -> Sequence[Task]:
        ...
        Official documentation: `tasks/tasks <https://apidoc.factorialhr.com/reference/post_api-2026-04-01-resources-tasks-tasks-bulk-create>`_
    ...
    async def bulk_delete(self, data: Mapping[str, typing.Any], **kwargs) -> Sequence[Task]:
        ...
        Official documentation: `tasks/tasks <https://apidoc.factorialhr.com/reference/post_api-2026-04-01-resources-tasks-tasks-bulk-delete>`_
    ...
    async def bulk_update(self, data: Mapping[str, typing.Any], **kwargs) -> Sequence[Task]:
        ...
        Official documentation: `tasks/tasks <https://apidoc.factorialhr.com/reference/post_api-2026-04-01-resources-tasks-tasks-bulk-update>`_
    ...
    async def copy(self, data: Mapping[str, typing.Any], **kwargs) -> Task:
        ...
        Official documentation: `tasks/tasks <https://apidoc.factorialhr.com/reference/post_api-2026-04-01-resources-tasks-tasks-copy>`_
    ...
    async def create_comment(self, data: Mapping[str, typing.Any], **kwargs) -> Task:
        ...
        Official documentation: `tasks/tasks <https://apidoc.factorialhr.com/reference/post_api-2026-04-01-resources-tasks-tasks-create-comment>`_
...
class TaskFilesEndpoint(Endpoint):
    ...
    async def all(self, **kwargs) -> ListApiResponse[TaskFile]:
        ...
        Official documentation: `tasks/task_files <https://apidoc.factorialhr.com/reference/get_api-2026-04-01-resources-tasks-task-files>`_
    ...
    async def get_by_id(self, file_id: int | str, **kwargs) -> TaskFile:
        ...
        Official documentation: `tasks/task_files <https://apidoc.factorialhr.com/reference/get_api-2026-04-01-resources-tasks-task-files-id>`_
    ...
    async def create(self, data: Mapping[str, typing.Any], **kwargs) -> TaskFile:
        ...
        Official documentation: `tasks/task_files <https://apidoc.factorialhr.com/reference/post_api-2026-04-01-resources-tasks-task-files>`_
    ...
    async def delete(self, file_id: int | str, **kwargs) -> TaskFile:
        ...
        Official documentation: `tasks/task_files <https://apidoc.factorialhr.com/reference/delete_api-2026-04-01-resources-tasks-task-files-id>`_
