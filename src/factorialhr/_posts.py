...
class CommentsEndpoint(Endpoint):
    ...
    async def all(self, **kwargs) -> ListApiResponse[Comment]:
        ...
        Official documentation: `posts/comments <https://apidoc.factorialhr.com/reference/get_api-2026-04-01-resources-posts-comments>`_
    ...
    async def get_by_id(self, comment_id: int | str, **kwargs) -> Comment:
        ...
        Official documentation: `posts/comments <https://apidoc.factorialhr.com/reference/get_api-2026-04-01-resources-posts-comments-id>`_
    ...
    async def create(self, data: Mapping[str, typing.Any], **kwargs) -> Comment:
        ...
        Official documentation: `posts/comments <https://apidoc.factorialhr.com/reference/post_api-2026-04-01-resources-posts-comments>`_
    ...
    async def update(self, comment_id: int | str, data: Mapping[str, typing.Any], **kwargs) -> Comment:
        ...
        Official documentation: `posts/comments <https://apidoc.factorialhr.com/reference/put_api-2026-04-01-resources-posts-comments-id>`_
    ...
    async def delete(self, comment_id: int | str, **kwargs) -> Comment:
        ...
        Official documentation: `posts/comments <https://apidoc.factorialhr.com/reference/delete_api-2026-04-01-resources-posts-comments-id>`_
...
class GroupsEndpoint(Endpoint):
    ...
    async def all(self, **kwargs) -> ListApiResponse[Group]:
        ...
        Official documentation: `posts/groups <https://apidoc.factorialhr.com/reference/get_api-2026-04-01-resources-posts-groups>`_
    ...
    async def get_by_id(self, group_id: int | str, **kwargs) -> Group:
        ...
        Official documentation: `posts/groups <https://apidoc.factorialhr.com/reference/get_api-2026-04-01-resources-posts-groups-id>`_
    ...
    async def create(self, data: Mapping[str, typing.Any], **kwargs) -> Group:
        ...
        Official documentation: `posts/groups <https://apidoc.factorialhr.com/reference/post_api-2026-04-01-resources-posts-groups>`_
    ...
    async def update(self, group_id: int | str, data: Mapping[str, typing.Any], **kwargs) -> Group:
        ...
        Official documentation: `posts/groups <https://apidoc.factorialhr.com/reference/put_api-2026-04-01-resources-posts-groups-id>`_
    ...
    async def delete(self, group_id: int | str, **kwargs) -> Group:
        ...
        Official documentation: `posts/groups <https://apidoc.factorialhr.com/reference/delete_api-2026-04-01-resources-posts-groups-id>`_
    ...
    async def archive(self, data: Mapping[str, typing.Any], **kwargs) -> Group:
        ...
        Official documentation: `posts/groups <https://apidoc.factorialhr.com/reference/post_api-2026-04-01-resources-posts-groups-archive>`_
...
class PostsEndpoint(Endpoint):
    ...
    async def all(self, **kwargs) -> ListApiResponse[Post]:
        ...
        Official documentation: `posts/posts <https://apidoc.factorialhr.com/reference/get_api-2026-04-01-resources-posts-posts>`_
    ...
    async def get_by_id(self, post_id: int | str, **kwargs) -> Post:
        ...
        Official documentation: `posts/posts <https://apidoc.factorialhr.com/reference/get_api-2026-04-01-resources-posts-posts-id>`_
    ...
    async def create(self, data: Mapping[str, typing.Any], **kwargs) -> Post:
        ...
        Official documentation: `posts/posts <https://apidoc.factorialhr.com/reference/post_api-2026-04-01-resources-posts-posts>`_
    ...
    async def update(self, post_id: int | str, data: Mapping[str, typing.Any], **kwargs) -> Post:
        ...
        Official documentation: `posts/posts <https://apidoc.factorialhr.com/reference/put_api-2026-04-01-resources-posts-posts-id>`_
    ...
    async def delete(self, post_id: int | str, **kwargs) -> Post:
        ...
        Official documentation: `posts/posts <https://apidoc.factorialhr.com/reference/delete_api-2026-04-01-resources-posts-posts-id>`_
