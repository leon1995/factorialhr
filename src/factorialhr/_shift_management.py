...
class ShiftManagementEndpoint(Endpoint):
    ...
    async def all(self, **kwargs) -> ListApiResponse[ShiftManagementShift]:
        ...
        Official documentation: `shift_management/shifts <https://apidoc.factorialhr.com/reference/get_api-2026-04-01-resources-shift-management-shifts>`_
    ...
    async def get_by_id(self, shift_id: int | str, **kwargs) -> ShiftManagementShift:
        ...
        Official documentation: `shift_management/shifts <https://apidoc.factorialhr.com/reference/get_api-2026-04-01-resources-shift-management-shifts-id>`_
    ...
    async def create(self, data: Mapping[str, typing.Any], **kwargs) -> ShiftManagementShift:
        ...
        Official documentation: `shift_management/shifts <https://apidoc.factorialhr.com/reference/post_api-2026-04-01-resources-shift-management-shifts>`_
    ...
    async def update(self, shift_id: int | str, data: Mapping[str, typing.Any], **kwargs) -> ShiftManagementShift:
        ...
        Official documentation: `shift_management/shifts <https://apidoc.factorialhr.com/reference/put_api-2026-04-01-resources-shift-management-shifts-id>`_
    ...
    async def delete(self, shift_id: int | str, **kwargs) -> ShiftManagementShift:
        ...
        Official documentation: `shift_management/shifts <https://apidoc.factorialhr.com/reference/delete_api-2026-04-01-resources-shift-management-shifts-id>`_
    ...
    async def bulk_create(self, data: Mapping[str, typing.Any], **kwargs) -> Sequence[ShiftManagementShift]:
        ...
        Official documentation: `shift_management/shifts <https://apidoc.factorialhr.com/reference/post_api-2026-04-01-resources-shift-management-shifts-bulk-create>`_
    ...
    async def bulk_delete(self, data: Mapping[str, typing.Any], **kwargs) -> Sequence[ShiftManagementShift]:
        ...
        Official documentation: `shift_management/shifts <https://apidoc.factorialhr.com/reference/post_api-2026-04-01-resources-shift-management-shifts-bulk-delete>`_
