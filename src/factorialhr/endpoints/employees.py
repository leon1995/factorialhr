...
class Employee(_base.Endpoint):
    ...
    def _endpoint(self) -> str:
        return '/2025-01-01/resources/employees/employees'
    ...
    async def update(self, *, employee_id: int, **kwargs) -> dict:
        ...
        return await self.api.put(f'{self._endpoint}/{employee_id}', **kwargs)
    ...
    async def single(self, *, employee_id: int, **kwargs) -> dict:
        ...
        return await self.api.get(f'{self._endpoint}/{employee_id}', **kwargs)
