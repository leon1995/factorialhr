...
class CustomResourcesSchemasEndpoint(Endpoint):
    ...
    async def all(self, **kwargs) -> ListApiResponse[Schema]:
        ...
        Official documentation: `custom_resources/schemas <https://apidoc.factorialhr.com/reference/get_api-2026-04-01-resources-custom-resources-schemas>`_
    ...
    async def get_by_id(self, schema_id: int | str, **kwargs) -> Schema:
        ...
        Official documentation: `custom_resources/schemas <https://apidoc.factorialhr.com/reference/get_api-2026-04-01-resources-custom-resources-schemas-id>`_
    ...
    async def create(self, data: Mapping[str, typing.Any], **kwargs) -> Schema:
        ...
        Official documentation: `custom_resources/schemas <https://apidoc.factorialhr.com/reference/post_api-2026-04-01-resources-custom-resources-schemas>`_
...
class ResourcesEndpoint(Endpoint):
    ...
    async def all(self, **kwargs) -> ListApiResponse[Resource]:
        ...
        Official documentation: `custom_resources/resources <https://apidoc.factorialhr.com/reference/get_api-2026-04-01-resources-custom-resources-resources>`_
    ...
    async def get_by_id(self, resource_id: int | str, **kwargs) -> Resource:
        ...
        Official documentation: `custom_resources/resources <https://apidoc.factorialhr.com/reference/get_api-2026-04-01-resources-custom-resources-resources-id>`_
...
class CustomResourcesValuesEndpoint(Endpoint):
    ...
    async def all(self, **kwargs) -> ListApiResponse[CustomResourcesValue]:
        ...
        Official documentation: `custom_resources/values <https://apidoc.factorialhr.com/reference/get_api-2026-04-01-resources-custom-resources-values>`_
    ...
    async def get_by_id(self, value_id: int | str, **kwargs) -> CustomResourcesValue:
        ...
        Official documentation: `custom_resources/values <https://apidoc.factorialhr.com/reference/get_api-2026-04-01-resources-custom-resources-values-id>`_
    ...
    async def create(self, data: Mapping[str, typing.Any], **kwargs) -> CustomResourcesValue:
        ...
        Official documentation: `custom_resources/values <https://apidoc.factorialhr.com/reference/post_api-2026-04-01-resources-custom-resources-values>`_
