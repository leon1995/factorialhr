...
class CodesEndpoint(Endpoint):
    ...
    async def all(self, **kwargs) -> ListApiResponse[Payrollintegrationsbasecode]:
        ...
        Official documentation: `payroll_integrations_base/codes <https://apidoc.factorialhr.com/reference/get_api-2026-04-01-resources-payroll-integrations-base-codes>`_
    ...
    async def create(self, data: Mapping[str, typing.Any], **kwargs) -> Payrollintegrationsbasecode:
        ...
        Official documentation: `payroll_integrations_base/codes <https://apidoc.factorialhr.com/reference/post_api-2026-04-01-resources-payroll-integrations-base-codes>`_
    ...
    async def update(self, code_id: int | str, data: Mapping[str, typing.Any], **kwargs) -> Payrollintegrationsbasecode:
        ...
        Official documentation: `payroll_integrations_base/codes <https://apidoc.factorialhr.com/reference/put_api-2026-04-01-resources-payroll-integrations-base-codes-id>`_
    ...
    async def delete(self, code_id: int | str, **kwargs) -> Payrollintegrationsbasecode:
        ...
        Official documentation: `payroll_integrations_base/codes <https://apidoc.factorialhr.com/reference/delete_api-2026-04-01-resources-payroll-integrations-base-codes-id>`_
